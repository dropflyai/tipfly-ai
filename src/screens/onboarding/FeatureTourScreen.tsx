...
const TOUR_SLIDES: TourSlide[] = [
  {
    ...
    subtitle: 'Log your tips in seconds',
    features: [
      'Quick entry with one tap',
      'Cash, card, or pooled tips',
  ...
  },
  {
    ...
    subtitle: 'See patterns, predict earnings',
    features: [
      'Smart income predictions',
      'Best shift analysis',
  ...
  },
  {
    ...
    icon: 'people-outline',
    iconColor: '#8B5CF6',
    title: 'Your Team, Fair Splits',
    subtitle: 'Pool tips and split fairly',
    features: [
      'Create tip pools instantly',
